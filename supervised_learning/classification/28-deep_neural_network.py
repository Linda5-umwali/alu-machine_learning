...
with a choice of activation function for the hidden layers"""
...
class DeepNeuralNetwork:
    ...
    def __init__(self, nx, layers, activation='sig'):
        ...
        Args:
            ...
            activation (str): type of activation function used in
                the hidden layers ('sig' or 'tanh')
        """
    ...
    @property
    def activation(self):
        """Getter for the activation function used in the hidden layers"""
        return self.__activation

    def forward_prop(self, X):
        """Calculates the forward propagation of the neural network,
        using a softmax activation on the output layer"""
        self.__cache['A0'] = X
